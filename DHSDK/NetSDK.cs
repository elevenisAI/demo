...
namespace NetSDKCS
{
    public static class NETClient
    {
        ...
        /// 设置回放YUC数据回调
        /// </summary>
        /// <param name="lPlayHandle">play back handle 回放句柄</param>
        /// <param name="cYUVData">callback function 回调函数</param>
        /// <param name="dwUser">user data, there is no data, please use IntPtr.Zero 用户数据</param>
        /// <returns>failed return false, successful return true 失败返回false 成功返回true</returns>
        ...
        /// <param name="lParam1">Parameter1 details refer to EM_A_EXTPTZ_ControlType 控制命令的参数1</param>
        /// <param name="lParam2">Parameter2 details refer to EM_A_EXTPTZ_ControlType 控制命令的参数2</param>
        /// <param name="lParam3">Parameter3 details refer to EM_A_EXTPTZ_ControlType 控制命令的参数3</param>
        ...
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstuInParam Indicates the input parameter of the interface</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        ...
        /// </summary>
        [Obsolete("此接口已弃用，原因是NET_OUT_SPLIT_GET_OSD_EX结构体过大，请使用形参为IntPtr的重载\n" +
        ...
        /// <summary>
        /// 开始目标检测/注册库的多通道查询(IVSS产品特色功能以图搜图支持两段式查询。第一步先上传大图并从中识别出目标小图，返回小图的SmallID，第二步用SmallID进行以图搜图)
        ...
        /// <summary>
        /// 平台下发轮询配置 < NET_IN_SET_POLLING_CONFIG pInParam > < NET_OUT_SET_POLLING_CONFIG pOutParam > 
        /// Set Polling Config
        /// </summary>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: 接口输入参数, 内存资源由用户申请和释放; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: 接口输出参数, 内存资源由用户申请和释放; [out] pstuOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime: 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE means success FALSE means failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pstuInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Interface input parameters</param>
        /// <param name="pOutParam">[out]pstuOutParam 接口输出参数, 内存资源由用户申请和释放; [out]pOutParam Interface output parameters</param>
        /// <param name="dwWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; Returns the realplay handle</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        ...
        /// <returns>TRUE 成功，FALSE 失败; TRUE for success, FALSE for failure</returns>
        ...
        /// <summary>
        /// 获取已添加的设备状态  inParam = NET_IN_GET_DEVICE_LIST_INFO, outParam = NET_OUT_GET_DEVICE_LIST_INFO 
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: 登录句柄; [in] lLoginID: login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: 接口输入参数, 内存资源由用户申请和释放; [in] pstuInParam: interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: 接口输出参数, 内存资源由用户申请和释放; [out] pstuOutParam: interface output parameters, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime: 接口超时时间, 单位毫秒; [in] nWaitTime: interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE means success FALSE means failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out]pstuOutParam 接口输出参数; [out] pstOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success. FALSE indicates failure</returns>
        ...
        /// <summary>
        /// 获取测温区域的参数值, pInParam与pOutParam内存由用户申请释放
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>订阅句柄; Attach handle</returns>
        ...
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Attach handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="emType">[in] emType 物模型服务类型; [in] emType service type</param>
        /// <param name="pInBuf">[in] pInBuf 接口输入参数，参考emType类型，内存资源由用户申请和释放; [in] pInBuf input param,memory resources are applied and released by the user</param>
        /// <param name="pOutBuf">[out] pOutBuf 接口输出参数, 参考emType类型，内存资源由用户申请和释放; [out] pOutBuf output param,memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>返回订阅句柄; Return subscription handle</returns>
        ...
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Subscription handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE Indicates success. FALSE Indicates failure</returns>
        ...
        /// 开始查找指纹信息
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID 登录句柄</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam 接口入参</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam 接口出参</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime 接口超时时间, 单位毫秒</param>
        /// <returns>返回控制句柄; 返回控制句柄</returns>
        ...
        /// 查询指纹信息
        /// </summary>
        /// <param name="lFindHandle">[in] lFindHandle 查询句柄; [in] lFindHandle 查询句柄</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam 接口入参</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam 接口出参</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime 接口超时时间, 单位毫秒</param>
        /// <returns>TRUE 表示成功 FALSE表示失败; TRUE 表示成功 FALSE表示失败</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录ID; [in] lLoginID Login ID</param>
        /// <param name="pInParam">[in] pInParam 接口入参; [in] pInParam Interface input parameter</param>
        /// <param name="pOutParam">[out] pOutParam 接口出参; [out] pOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout time in milliseconds</param>
        /// <returns>TRUE 表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        ...
        /// <summary>
        /// 关窗(pInparam, pOutParam内存由用户申请释放)
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID login handle</param>
        /// <param name="pstuInParam">[in] pstInParam 接口输入参数; [in] pstInParam Interface input parameter</param>
        /// <param name="pstuOutParam">[out] pstOutParam 接口输出参数; [out] pstOutParam Interface output parameter</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功,FALSE表示失败; TRUE means success FALSE means failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID login handle</param>
        /// <param name="pInParam">[in] pstInParam 接口输入参数; [in] pstInParam interface input parameter</param>
        /// <param name="pOutParam">[out]pstOutParam 接口输出参数; [out]pstOutParam interface output parameter</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE means success FALSE means failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口输入参数; [in] pstuInParam The input parameters for the interface, memory resources are allocated and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam The output parameters for the interface, memory resources are allocated and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>返回订阅句柄; Return subscription handle</returns>
        ...
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle 订阅句柄; [in] lAttachHandle Subscription handle</param>
        /// <returns>TRUE表示成功 FALSE表示失败; indicates success, FALSE indicates failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam 接口入参; [in] pstuInParam Interface input parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam 接口出参; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout time, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success, FALSE indicates failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒(目前不生效, 保留在此以便后续扩展); [in] nWaitTime Interface timeout in milliseconds(It does not take effect at present. It is reserved here for subsequent expansion)</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        ...
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <returns>业务sdk句柄，非0表示成功 0表示失败; Sub business module handle, Non 0 means success and 0 means failure</returns>
        ...
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <returns>子链接监听服务句柄, 非0表示成功 0表示失败; Sub libk listen server handle, Non 0 means success and 0 means failure</returns>
        ...
        /// </summary>
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Input param, resources are requested and released by users</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam Output param, resources are requested and released by users</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:Success FALSE:Failed</returns>
        ...
        /// </summary>
        /// <param name="lSubBizHandle">[in] lSubBizHandle 业务sdk句柄，由CLIENT_CreateSubBusinessModule接口返回; [in] lSubBizHandle Sub business handle, it is returned by CLIENT_CreateSubBusinessModule</param>
        /// <param name="pInParam">[in] pInParam 接口输入参数, 内存资源由用户申请和释放; [in] pInParam Input param, resosurces are requested and released by users</param>
        /// <param name="pOutParam">[out] pOutParam 接口输出参数, 内存资源由用户申请和释放; [out] pOutParam Output param, resources are requested and released by userss</param>
        /// <returns>LLONG 透传隧道业务句柄，非0表示成功 0表示失败; LLONG Private tunnel handle, Non 0 means success and 0 means failure</returns>
        ...
        /// </summary>
        /// <param name="lTransmitHandle">[in] lTransmitHandle 透传隧道业务句柄，由CLIENT_CreateTransmitTunnel接口返回; [in] lTransmitHandle Private tunnel handle, it is returned by CLIENT_CreateTransmitTunnel</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:Success FALSE:Failed</returns>
        ...
        /// </summary>
        /// <param name="lSubBizHandle">[in] lSubBizHandle 业务sdk句柄，由CLIENT_CreateSubBusinessModule接口返回; [in] lSubBizHandle:sub business module handle, it is returned by CLIENT_CreateSubBusinessModule</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        ...
        /// </summary>
        /// <param name="lListenServer">[in] lListenServer 监听服务句柄，由CLIENT_StartSubLinkListenServer接口返回; [in] lListenServer:sub link listen server handle, it is returned by CLIENT_StartSubLinkListenServer</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE:success FALSE:failed</returns>
        ...
        /// <param name="pstuOutParam">[out] pstuOutParam 接口输出参数; [out] pstuOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>返回订阅句柄; Returns the subscription handle</returns>
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool GetMobileModuleState(IntPtr lLoginID, ref NET_IN_GET_MOBILE_MODULE_STATE pInParam, ref NET_OUT_GET_MOBILE_MODULE_STATE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetMobileModuleState(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE表示成功 FALSE表示失败</returns>
        public static bool GetMobileSIMInfo(IntPtr lLoginID, EM_SIMINFO_TYPE emType, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetMobileSIMInfo(lLoginID, emType, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool RPC_NetApp(IntPtr lLoginID, EM_RPC_NETAPP_TYPE emType, IntPtr pstuIn, IntPtr pstuOut, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RPC_NetApp(lLoginID, emType, pstuIn, pstuOut, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID 登录句柄; [in] lLoginID Login handle</param>
        /// <param name="pstInParam">[in] pstInParam 接口输入参数; [in] pstInParam Indicates the interface parameter</param>
        /// <param name="pstOutParam">[out] pstOutParam 接口输出参数; [out] pstOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success. FALSE indicates failure</returns>
        public static bool StartFindDetailNumberStatCluster(IntPtr lLoginID, ref NET_IN_START_FIND_DETAIL_CLUSTER pstInParam, ref NET_OUT_START_FIND_DETAIL_CLUSTER pstOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StartFindDetailNumberStatCluster(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime 接口超时时间, 单位毫秒; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE表示成功 FALSE表示失败; TRUE indicates success. FALSE indicates failure</returns>
        public static bool StopFindDetailNumberStatCluster(IntPtr lLoginID, ref NET_IN_STOP_FIND_DETAIL_CLUSTER_INFO pstInParam, ref NET_OUT_STOP_FIND_DETAIL_CLUSTER_INFO pstOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopFindDetailNumberStatCluster(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
    ...
    /// 回放YUV数据回调函数
    /// </summary>
    /// <param name="lPlaybackHandle">monitor handle 预览句柄</param>
    /// <param name="pBuffer">byte array, length is dwBufSize 回调数据缓存
    ///                      <para>callback data, except type 0, other type is base on frame, one frame data per callback</para></param>
    /// <param name="dwBufSize">pBuffer's size 回调数据的缓存大小</param>
    /// <param name="param">pointer to parameter structure,based on different type 参数结构体的指针
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle subscription handle</param>
    /// <param name="pstResult">[out] pstResult 物模型属性订阅回调信息; [out] pstResult things data info</param>
    /// <param name="dwUserData">[out] dwUserData 用户信息; [out] dwUserData User Info</param>
    ...
    /// <summary>
    /// 订阅训练任务完成情况接口回调函数原型, lAttachHandle 为 CLIENT_AttachTrainTask 接口的返回值
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuTrainTaskInfo">[out] pstuTalkDevTaskState 操作执行状态信息; [out] pstuTalkDevTaskState Operation execution status information</param>
    ...
    /// </summary>
    /// <param name="pstuNotifyIVSEventDetailInfo">[out] pstuNotifyIVSEventDetailInfo 获取事件的详细信息; [out] pstuNotifyIVSEventDetailInfo Obtain detailed information about the event</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuElevatorFloorCounterInfo">[out] pstuCentraProxyActionInfo 操作执行状态信息; [out] pstuCentraProxyActionInfo Operation execution status information</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    ...
    /// <summary>
    /// 订阅标定状态接口回调函数原型, lAttachHandle 为 CLIENT_AttachCalibrateStatus 接口的返回值
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuCalibrateStatusInfo">[out] pstuCalibrateStatusInfo 标定状态信息; [out] pstuCalibrateStatusInfo Calibration status information</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser User Information</param>
    /// <returns>void; void</returns>
    ...
    /// </summary>
    /// <param name="lListenServer">[out] lListenServer 子链接监听服务句柄, 由CLIENT_StartSubLinkListenServer接口返回; [out] lListenServer:Sublink server handle, it is returned by CLIENT_StartSubLinkListenServer</param>
    /// <param name="lSubBizHandle">[out] lSubBizHandle 分压业务sdk句柄, 由CLIENT_CreateSubBusinessModule接口返回; [out] lSubBizHandle: sub business module handle, it is returned by CLIENT_CreateSubBusinessModule</param>
    /// <param name="pstSubLinkCallBack">[out] pstSubLinkCallBack 子链接监听服务回调信息; [out] pstSubLinkCallBack: callback info of sublink server @retval void</param>
    ...
    /// </summary>
    /// <param name="lSubBizHandle">[out] lSubBizHandle 分压模块句柄, 由CLIENT_CreateSubBusinessModule接口返回; [out] lSubBizHandle: Sub business handle, it is returned by CLIENT_CreateSubBusinessModule</param>
    /// <param name="lOperateHandle">[out] lOperateHandle 业务句柄; [out] lOperateHandle: Opreate handle</param>
    /// <param name="pstDisConnectInfo">[out] pstDisConnectInfo 断线回调数据; [out] pstDisConnectInfo: Disconnect callback info of private tunnel</param>
    /// <returns>void; void</returns>
    ...
    /// </summary>
    /// <param name="lSubBizHandle">[out] lSubBizHandle 分压业务sdk句柄, 由CLIENT_CreateSubBusinessModule接口返回; [out] lSubBizHandle: Sub business module handle, it is retuened by CLIENT_CreateSubBusinessModule</param>
    /// <param name="lOperateHandle">[out] lOperateHandle 业务句柄; [out] lOperateHandle: Operate handle</param>
    /// <param name="pstDisConnectInfo">[out] pstDisConnectInfo 断线回调数据; [out] pstDisConnectInfo: Call back info of disconnect @retval void</param>
    /// <returns>void</returns>
    public delegate void fSubBizDisConnectCallBack(IntPtr lSubBizHandle, IntPtr lOperateHandle, IntPtr pstDisConnectInfo);

    /// <summary>
    /// 订阅485实时数据接口回调函数原型, lAttachHandle 为 CLIENT_AttachIotboxComm 接口的返回值
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle 订阅句柄; [out] lAttachRecalHandle Subscription handle</param>
    /// <param name="pstuIotboxComm">[out] pstuIotboxComm 订阅的485实时数据; [out] pstuIotboxComm Subscribed 485 real-time data</param>
    /// <param name="dwUser">[out] dwUser 用户信息; [out] dwUser user information</param>
    /// <returns>void; void</returns>
